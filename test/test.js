  ...
  describe('#imgdec', () => {
    ...
    it('should transcode Freedom.png to Freedom.jpeg', (done) => {
      create_test('img',
        'universal-img',
        "solver",
        "rfimg;ffsws;jpgenc;rfimg;imgdec",
        "https://bevara.ddns.net/test-signals/Freedom.png",
  ...
  describe('#theoradec', () => {
    it('should decode Big_Buck_Bunny_Trailer_400p.ogv"', (done) => {
      create_test('video',
        "universal-video",
        "solver",
        "theoradec;mp4mx;rfnalu;ffenc;oggdmx",
  ...
  describe('#mpeg', () => {
    it('should decode centaur_2.mpg', (done) => {
      create_test('video',
        "universal-video",
        "solver",
        "m2psdmx;rfmpgvid;ffdec;mp4mx;rfnalu;ffenc",
  ...
  describe('#xvid', () => {
    it('should decode Big_Buck_Bunny_Trailer_400p.avi"', (done) => {
      create_test('video',
        "universal-video",
        "solver",
        "mp4mx;avidmx;xviddec;rfmp3;rfmpgvid;rfnalu;ffenc",
