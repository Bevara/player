  ...
  describe('#xvid', () => {
    it('should decode Big_Buck_Bunny_Trailer_400p.avi"', (done) => {
      create_test('video',
        "universal-video",
        "solver_1.0",
        "mp4mx_1.0;avidmx;xviddec_1.0;libmad_1.0;rfmpgvid_1.0;rfnalu_1.0;ffmpeg_1.0",
